...
public class Level2 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        waveText.text = "Wave: " + (1 + Convert.ToInt32(wave2Spawned) + Convert.ToInt32(wave3Spawned) + Convert.ToInt32(boss2Spawned)).ToString();
        ...
        else if (!isTransitioning && enemiesAliveNames.Count == 0 && wave3Spawned && !boss2Spawned)
        {
            boss2Spawned = true;
            isTransitioning = true;
    ...
    private IEnumerator SpawnBoss2()
    {
        yield return new WaitForSeconds(3f);
        Instantiate(boss2Prefab, enemySpawn1.transform.position, Quaternion.identity);
        enemiesAliveNames.Add(boss2Prefab.name);
        isTransitioning = false;
    }
